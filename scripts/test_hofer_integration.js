...
assert(app.includes('const AUTO_MATCH_STORES = ["mpreis", "spar", "tg", "billa", "hofer"]'), "HOFER fehlt im Auto-Matching");
...
assert(app.includes("const AUTO_MATCH_ENGINE_VERSION = 4"), "Matching-Engine-Version nicht erhöht");
