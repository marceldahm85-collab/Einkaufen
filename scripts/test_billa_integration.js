...
assert(app.includes('const AUTO_MATCH_STORES = ["mpreis", "spar", "tg", "billa", "hofer", "lidl"]'), "BILLA/HOFER fehlen im Auto-Matching");
...
assert(app.includes('const promotionsSupported = ["mpreis", "spar", "tg", "billa", "hofer", "lidl"].includes(currentCatalogRetailer)'), "BILLA/HOFER-Aktionsfilter nicht aktiviert");
