...
def normalize_item(item: dict):
    if str(item.get("store") or "").lower() != "lidl":
        return None
...
def main() -> int:
    ...
    try:
        ...
        payload = {
            ...
            "importerVersion": 2,
            "store": "lidl",
            "scope": "LIDL-Daten aus Heisse Preise",
            "provider": "heisse-preise.io",
        ...
        print(
            ...
            f"{skipped} LIDL-Einträge übersprungen."
        )
        return 0
        ...
        # solange die öffentliche LIDL-Datei noch leer ist.
        write_status(
            "error",
            updated_at,
            existing_count,
